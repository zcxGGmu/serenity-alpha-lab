...
| 因子 | 原始分 | 加权贡献 | 证据 |
|---|---:|---:|---|
| bottleneck scarcity | 53 | 12.7 | github:onebluecloud/serenity-playbook:46a7c9034064, github:onebluecloud/serenity-playbook:ea8d18d130d5, github:yan-labs/serenity-aleabitoreddit:ccb67a64ba63, github:yijiashu/serenity-skill:08537f7e63aa, github:yijiashu/serenity-skill:5b04efcd1a4a, github:yijiashu/serenity-skill:683354848f79, github:yijiashu/serenity-skill:7467eddc220e, github:yijiashu/serenity-skill:954715ca7869, github:yijiashu/serenity-skill:c1b7c405ed10 |
| demand certainty | 62 | 13.6 | github:onebluecloud/serenity-playbook:46a7c9034064, sec-companyfacts:NVDA:dd4dcebbdfc5, official-report:SIVE:cpo-pipeline-2025, official-report:SIVE:net-sales-2025, github:onebluecloud/serenity-playbook:ea8d18d130d5, github:yan-labs/serenity-aleabitoreddit:ccb67a64ba63, github:yijiashu/serenity-skill:08537f7e63aa, github:yijiashu/serenity-skill:5b04efcd1a4a, github:yijiashu/serenity-skill:683354848f79, github:yijiashu/serenity-skill:7467eddc220e, github:yijiashu/serenity-skill:954715ca7869, github:yijiashu/serenity-skill:a8c70ad14a6b, github:yijiashu/serenity-skill:c1b7c405ed10 |
| supply elasticity | 27 | 4.3 | manual:NVDA:risk:guarded-source, github:onebluecloud/serenity-playbook:46a7c9034064, github:onebluecloud/serenity-playbook:ea8d18d130d5, github:yan-labs/serenity-aleabitoreddit:ccb67a64ba63, github:yijiashu/serenity-skill:08537f7e63aa, github:yijiashu/serenity-skill:5b04efcd1a4a, github:yijiashu/serenity-skill:683354848f79, github:yijiashu/serenity-skill:7467eddc220e, github:yijiashu/serenity-skill:954715ca7869 |
| evidence quality | 94 | 15.0 | manual:NVDA:risk:guarded-source, github:onebluecloud/serenity-playbook:46a7c9034064, sec-companyfacts:NVDA:31dc7119e66f, sec-companyfacts:NVDA:3307c8faf037, sec-companyfacts:NVDA:dd4dcebbdfc5, official-report:SIVE:cpo-pipeline-2025, official-report:SIVE:net-sales-2025, github:onebluecloud/serenity-playbook:ea8d18d130d5, github:yan-labs/serenity-aleabitoreddit:ccb67a64ba63, github:yijiashu/serenity-skill:08537f7e63aa, github:yijiashu/serenity-skill:5b04efcd1a4a, github:yijiashu/serenity-skill:683354848f79, github:yijiashu/serenity-skill:7467eddc220e, github:yijiashu/serenity-skill:954715ca7869, github:yijiashu/serenity-skill:a8c70ad14a6b, github:yijiashu/serenity-skill:c1b7c405ed10 |
| crowding risk (扣分) | 14 | -1.7 | github:onebluecloud/serenity-playbook:46a7c9034064 |
| invalidation clarity | 22 | 2.2 | github:onebluecloud/serenity-playbook:46a7c9034064, sec-companyfacts:NVDA:31dc7119e66f, sec-companyfacts:NVDA:3307c8faf037, sec-companyfacts:NVDA:dd4dcebbdfc5, github:onebluecloud/serenity-playbook:ea8d18d130d5, github:yan-labs/serenity-aleabitoreddit:ccb67a64ba63, github:yijiashu/serenity-skill:08537f7e63aa, github:yijiashu/serenity-skill:5b04efcd1a4a, github:yijiashu/serenity-skill:683354848f79, github:yijiashu/serenity-skill:7467eddc220e, github:yijiashu/serenity-skill:954715ca7869, github:yijiashu/serenity-skill:a8c70ad14a6b, github:yijiashu/serenity-skill:c1b7c405ed10 |

## 投资分析结论

NVDA 当前可进入 Serenity 候选池复核。综合研究评分为 46/100，报告使用 16 条证据，其中 primary/fact 证据 5 条、风险/失效证据 2 条。下一步重点不是给出买卖建议，而是验证景气链条、瓶颈位置和业绩兑现路径。

## Serenity 选股因子

- **景气方向:** 当前证据覆盖 9 条正向线索和 2 条负向线索，需要判断需求是否已经传导到订单或收入。
- **产业链位置:** 已识别环节包括 AI accelerator customer、company financials、component、interconnect、memory、methodology、optical components，优先寻找供需最紧、替代最难的节点。
...
| 优先级 | 缺口 | 影响 | 下一步证据 |
|---|---|---|---|
| P1 | maintenance | 当前没有主要短板，但结论仍会随新证据过期。 | 继续跟踪 NVDA 的 primary evidence、风险证据和反证条件。 |

## 论点摘要

NVDA 目前形成的是一个临时性的 Serenity 风格研究案例，覆盖 AI accelerator customer、company financials、component、interconnect、memory、methodology、optical components。当前最强主题包括 AI infrastructure、AI supply-chain、CPO、Chinese skill、SEC companyfacts。该案例由 9 条正向证据支撑，同时受到 2 条明确风险证据约束。只有当 primary evidence 进一步确认客户验证、收入爬坡节奏和替代供给受限时，研究置信度才应提高。

## 声明类型组合

fact: 5, inference: 9, risk: 2

## 来源覆盖

**Focus ticker:** NVDA

**Coverage counts:** evidence 16, focus ticker 14, primary/fact 3, risk 2, external non-Serenity 6
...
- **维护动作:** 继续跟踪 NVDA 的新增 primary evidence、风险证据和反证条件，避免结论过期。

## 后续研究任务

- 为 AI accelerator customer、company financials、component、interconnect、memory、methodology、optical components 建立来源表，覆盖 primary filings、客户引用和产能线索。
- 对每一条关键论点区分直接证据与推断链接。
