...
LITE 当前可进入 Serenity 候选池复核。综合研究评分为 21/100，报告使用 16 条证据，其中 primary/fact 证据 3 条、风险/失效证据 4 条。下一步重点不是给出买卖建议，而是验证景气链条、瓶颈位置和业绩兑现路径。
...
| component | 11 | 0 | 2 | A-share, AI infrastructure, AI supply-chain, CPO, Claude skill |
