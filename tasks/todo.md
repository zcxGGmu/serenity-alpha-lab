...
- [ ] Create Chinese checkpoint commit for `SAL-P6-003`.
...
- Chinese implementation checkpoint will be generated by the `SAL-P6-003` commit and then backfilled in the status documents.
