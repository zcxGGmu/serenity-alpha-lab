...
- [ ] Review, stage only `SAL-P4-006` files and create the required Chinese checkpoint commit.
...
- Implementation checkpoint: generated by the upcoming Chinese checkpoint commit; status-sync checkpoint will be updated with the actual hash after commit.
