...
- [x] **Step 2: Assert route metadata**
...
- [x] **Step 3: Assert Idempotency-Key and 202 run response**
...
- [x] **Step 4: Assert stable paginated results**
...
- [x] **Step 5: Assert comparison and ProblemDetails mapping**
...
- [x] **Step 1: Define route and response DTOs**
...
- [x] **Step 2: Add request and repository DTOs**
...
- [x] **Step 3: Implement definition endpoints**
...
- [x] **Step 4: Implement async run response**
...
- [x] **Step 5: Implement result and comparison queries**
...
- [x] **Step 4: Update next-session prompt**
